...
ActiveRecord::Schema.define(version: 2020_12_27_065545) do
  ...
  create_table "buyer_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_record_id"], name: "index_buyer_addresses_on_purchase_record_id"
  end
  ...
  add_foreign_key "buyer_addresses", "purchase_records"
